...
public class XkApsResourceController {
    ...
    */
    ...
    public APIResponse<XkApsResourceDto> remove(@PathVariable String id) {
    ...
    */
    ...
    public APIResponse<XkApsResourceDto> update(@PathVariable("id") String id,@RequestBody XkApsResourceDto formData) throws Exception {
        if (null != formData) {
            return new APIResponse<XkApsResourceDto>(xkApsResourceService.save(formData));
        }
        return new APIResponse<XkApsResourceDto>(-1, "数据传输为空");
