...
public class XkApsOperationController {
    ...
    */
    ...
    public APIResponse<XkApsOperationDto> remove(@PathVariable String id) {
    ...
    */
    ...
    public APIResponse<XkApsOperationDto> update(@PathVariable("id") String id,@RequestBody XkApsOperationDto formData) throws Exception {
        if (null != formData) {
            return new APIResponse<XkApsOperationDto>(xkApsOperationService.save(formData));
        }
        return new APIResponse<XkApsOperationDto>(-1, "数据传输为空");
