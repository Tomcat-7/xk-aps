...
*/
@RestController
@RequestMapping("/api/aps/xkApsBom")
@Api(tags = {"Bom表信息管理"}, description = "提供Bom表模块增删查改接口")
public class XkApsBomController {

    @Autowired
    private IXkApsBomService xkApsBomService;

    @ApiOperation(value = "分页获取Bom表信息", httpMethod = "GET", notes = "分页获取Bom表数据，注意分页参数")
    ...
    * @param id  一键生成单表模块id
    */
    @ApiOperation(value = "根据id获取Bom表详细信息", notes = "根据url的id来获取Bom表详细信息",httpMethod="GET")
    ...
    */
    @ApiOperation(value = "保存Bom表信息", httpMethod = "POST", notes = "保存Bom表信息，注意保存时需要传递的参数")
    ...
    * @param id 一键生成单表模块id
    */
    @ApiOperation(value = "删除单个Bom表信息", notes = "根据url的id来指定删除Bom表对象", httpMethod = "DELETE")
    @ApiImplicitParam(name = "id", value = "主键id", required = true, dataType = "String")
    ...
    */
    @ApiOperation(value = "删除多个Bom表信息", notes = "根据url的id来指定删除Bom表对象", httpMethod = "DELETE")
    ...
    * @param
    */
    @ApiOperation(value = "更新Bom表数据", httpMethod = "PUT")
    @ApiImplicitParams({
