...
*/
@RestController
@RequestMapping("/api/aps/xkApsItem")
@Api(tags = {"品目表信息管理"}, description = "提供品目表信息模块增删查改接口")
public class XkApsItemController {

    @Autowired
    private IXkApsItemService xkApsItemService;

    @ApiOperation(value = "分页获取品目表信息", httpMethod = "GET", notes = "分页获取数据，注意分页参数")
    ...
    * @param id  一键生成单表模块id
    */
    @ApiOperation(value = "根据id获取品目表信息详细信息", notes = "根据url的id来获取详细信息",httpMethod="GET")
    ...
    */
    @ApiOperation(value = "保存品目表信息", httpMethod = "POST", notes = "保存信息，注意保存时需要传递的参数")
    ...
    * @param id 一键生成单表模块id
    */
    @ApiOperation(value = "删除单个品目表信息信息", notes = "根据url的id来指定删除对象", httpMethod = "DELETE")
    @ApiImplicitParam(name = "id", value = "主键id", required = true, dataType = "String")
    ...
    */
    @ApiOperation(value = "删除多个品目表信息信息", notes = "根据url的id来指定删除对象", httpMethod = "DELETE")
    ...
    * @param
    */
    @ApiOperation(value = "更新品目表信息数据", httpMethod = "PUT")
    @ApiImplicitParams({
