...
public class GATest {
    ...
    private int gnmax = 1000;//最大代数
    private double pc = 0.9; //交叉概率
    private double pm = 0.3; //变异概率
    ...
    public static void main(String[] args) {
        List<List<double[][]>> scheduleData = new ArrayList<>();

//        double[][] doubles1 = new double[6][2];
//        double[][] doubles2 = new double[6][2];
//        double[][] doubles3 = new double[6][2];
//        double[][] doubles4 = new double[6][2];
//        double[][] doubles5 = new double[3][2];
//        //job1
//        doubles1[0][0] = 6.4;
//        doubles1[0][1] = 1;
//        doubles1[1][0] = 20.41;
